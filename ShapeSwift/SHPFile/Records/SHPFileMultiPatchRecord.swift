...
extension SHPFileMultiPatchRecord {
  struct Parser {
    ...
    let partTypes: ShapeDataArrayParser<MultiPatchPartType, LittleEndian>
    ...
    init(data: Data, start: Int) throws {
      ...
      partTypes = ShapeDataArrayParser<MultiPatchPartType, LittleEndian>(start: parts.end, count: numParts)
      points = ShapeDataArrayParser<Coordinate2D, LittleEndian>(start: partTypes.end, count: numPoints)
